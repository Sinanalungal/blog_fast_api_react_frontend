...
const Drawer = ({ isOpen, onClose, blog }) => {
  ...
  const drawerContent = (
    <motion.div
      className="fixed bottom-0 overflow-y-auto font-roboto scrollbar-hide z-10 lg:px-20 transform -translate-x-1/2 w-full h-[90vh] bg-white border rounded-t-3xl"
      initial={{ y: "100%" }}
      ...
      <div className="max-w-7xl break-words">
        <div className="p-6 flex items-center flex-col md:px-36 h-full scrollbar-hide">
          ...
          <img
            ...
            alt={blog.title}
            className="h-[90%] w-[95%] object-cover mb-4 rounded-lg"
          />
